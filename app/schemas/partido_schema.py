...
class PartidoSchema(ma.SQLAlchemyAutoSchema):
    ...
    arbitro_nombre = fields.String(allow_none=True, validate=validate.Length(max=120))
    arbitro_asistente1 = fields.String(allow_none=True, validate=validate.Length(max=120))
    arbitro_asistente2 = fields.String(allow_none=True, validate=validate.Length(max=120))
